...
while keep_going :
    ...
    for i in range(5):           # "Roll" a random number from 1-6 for all5 dice
    ...
    # ThreeofAKind - first three, middle three, or last three are same
    elif (dice[0]  == dice[2]) or (dice[1] == dice[3]) or (dice[1] == dice[4]):
