...
number_of_pizzas = eval(input("Dear customer , how many pizzas do you want ? "))

# Ask for the menu cost of each pizza.
cost_per_pizza = eval(input("Mister manager how much does each pizza cost ? "))

# Calculate the total cost of the pizzas as our subtotal.
subtotal = number_of_pizzas * cost_per_pizza

# Calculate the sales owed, at 8 percent of the subtotal.
